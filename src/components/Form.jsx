            ...
            <form>
                <table border="0" cellPadding="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0">
                                ...
                                <tr>
                                    <td></td>
                                    <td align="center"><small>(10 char max)</small></td>
                                    <td align="center"><small>(upto 2 decimal)</small></td>
                                    <td></td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            BCA <input type="radio" name="c" />
                            B.Com <input type="radio" name="c" />
                            B.Sc <input type="radio" name="c" />
                            B.A <input type="radio" name="c" />
                        </td>
                    </tr>
